...
<Canvas>
  <Story name="Disable top bar behaviour" parameters={{ layout: "fullscreen" }}>
    {html`
      <div style="display:flex; height:100%;">
        <ic-side-navigation
          app-title="Application Name"
...
### With top classification banner

<Canvas>
  <Story name="With top classification banner" parameters={{ layout: "fullscreen" }}>
    {html`
      <div style="display:flex; height:100%;">
        <ic-side-navigation
          app-title="Application Name"
        ...
        >
          ...
          <ic-classification-banner
            classification="official" top="true"
          ></ic-classification-banner>
        </div>
      </div>
    `}
